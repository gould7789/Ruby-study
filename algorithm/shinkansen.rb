...
# 함수 작성
def weekly_7_days_sales(ticket_price)
  # $250를 기준으로 +- 기준값 계산
  standard = (250 - ticket_price) / 10.0

  # 150000에서 +- 할 합계
  total = 7000 * standard
  # 결과값
  result = 150_000 + total

  result.to_i
end

puts weekly_7_days_sales(260)
puts weekly_7_days_sales(255)
puts weekly_7_days_sales(220)
